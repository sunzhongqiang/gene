...
/**
 * 基础查询类，提供便捷的sql或者jpql快速查询，封装比较重复的 查询<br> 针对那个实体进行查询，如果传入，一些方法会返回该类，尽量写
 * 
...
public interface BaseQueryDao<T> {
     ...
     * 使用sql进行更新数据.
     * 
     * @param updateSql 执行的语句
     * @param params 参数
     * @return 返回影响的条数
     */
    int executeNativeUpdate(String updateSql, Map<Integer, Object> params);
