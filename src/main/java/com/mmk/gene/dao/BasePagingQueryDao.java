...
public interface BasePagingQueryDao<T> extends BaseQueryDao<T> {
    ...
    List<Map<String, Object>> queryFieldsByJpql(String ql, Map<String, Object> params, Long start,
            Long limit);
    ...
    List<Map<String, Object>> queryFieldsBySql(String sql, Map<Integer, Object> params, Long start,
            Long limit);
