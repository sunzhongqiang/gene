...
public interface SpringDataQueryDao<T> extends BasePagingQueryDao<T> {
     ...
     * @return 分页结果
     */
    Page<Map<String, Object>> queryFieldsByJpql(String ql, Map<String, Object> params,
            Pageable pageable);
     ...
     * @return 分页结果
     */
    Page<Map<String, Object>> queryFieldsBySql(String ql, Map<Integer, Object> params,
            Pageable pageable);
